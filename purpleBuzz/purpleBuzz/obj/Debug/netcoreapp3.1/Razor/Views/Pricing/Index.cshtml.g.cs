#pragma checksum "C:\Users\Huseyn\source\repos\purpleBuzz\purpleBuzz\Views\Pricing\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "47259e7da79f703083373e4f94f11b9cd38c4c84"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"47259e7da79f703083373e4f94f11b9cd38c4c84", @"/Views/Pricing/Index.cshtml")]
        ...
        <div class=""col-md-4 pt-sm-0 pt-3 px-xl-3"">
            <div class=""pricing-table card bg-secondary h-100 card-rounded shadow-sm border-0 py-5"">
                <div class=""pricing-table-body card-body text-center text-white align-self-center p-md-0"">
                    ...
                    <p>$120/Year</p>
                    <ul");
            WriteLiteral(@" class=""pricing-table-list text-start text-dark px-4 list-unstyled light-300"">
        ...
        <div class=""col-md-4 pb-5 pt-sm-0 mt-5 px-xl-3"">
            <div class=""pricing-table card h-100 shadow-sm border-0 py-5"">
                <div class=""pricing-table-body card-body text-center align-self-center p-md-0"">
                    <i ");
            WriteLiteral(@"class=""pricing-table-icon display-3 bx bx-package text-secondary""></i>
...
<section class=""bg-light pt-sm-0 py-5"">
  ...
  ");
        ...
        <div class=""pricing-horizontal row col-10 m-auto d-flex shadow-sm rounded overflow-hidden my-5 bg-white"">
            ...
            <div class=""pricin");
            WriteLiteral(@"g-horizontal-body offset-lg-1 col-md-5 col-lg-4 d-flex align-items-center pl-5 pt-lg-0 pt-4"">
                <ul class=""text-left px-4 list-unstyled mb-0 light-300"">
        ...
        <div class=""pricing-horizontal row col-10 m-auto d-flex shadow-sm rounded overflow-hidden bg-white"">
            ...
            WriteLiteral(@"-icon col-md-3 text-center bg-secondary text-light py-4"">
                <i class=""display-1 bx bx-package pt-4""></i>
            ...
            <div class=""pricing-horizontal-tag col-md-4 text-center pt-3 d-flex align-items-center"">
                <div class=""w-100 light-300"">
                    <p>$840/Year</p>
                    <a href=""#"" class=""btn rounded-pill px-4 btn");
            WriteLiteral(@"-outline-primary mb-3"">Get Now</a>
                </div>
            </div>
        </div>
        <!-- End Pricing Horizontal -->
...
<section class=""container py-5"">
    ...
    <div class=""row d-flex align-items-center pb-5"">
        ...
        <div class=""col-lg-6 offset-lg-0 col-md-8 offset-md-2"">
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "47259e7da79f703083373e4f94f11b9cd38c4c8413160", async() => {
            }
            );
